        ...
        LazyColumn(
            ...
            item {
                ...
                ReplyEmailDetailsCard(
                    ...
                    modifier =
                    if (isFullScreen) Modifier.padding(horizontal = dimensionResource(R.dimen.detail_card_outer_padding_horizontal))
                    else Modifier.padding(end = dimensionResource(id = R.dimen.detail_card_outer_padding_horizontal))
                )
            }
        }
    }
